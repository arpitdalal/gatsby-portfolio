        ...
        <div className="p-3">
          ...
          <h2 className="d-flex justify-content-center anim">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" width="40" height="40">
              ...
              <path className="fill-color" d="m25 28.965.134-.044-.071-1.255-9.244-1.809-4.819 27.143a1 1 0 0 0 .831 1.144l20.026 3.676a1 1 0 0 0 1.143-.82l-.552-5.648z" fill="#7f5af0"/>
              ...
              <path className="fill-color" d="m46 22-21 6.965 8.661 26.035a1.077 1.077 0 0 0 1.339.62l19.332-6.354a.988.988 0 0 0 .668-1.266z" fill="#7f5af0"/>
              <g fill="#f9f2cc">
              ...
              <path d="m40.455 33.265h1.999v20.081h-1.999z" transform="matrix(.94671111 -.32208395 .32208395 .94671111 -11.739 15.66)"/>
              <path d="m35.337 35.006h1.999v20.081h-1.999z" transform="matrix(.94671111 -.32208395 .32208395 .94671111 -12.573 14.104)"/>
              <path d="m45.574 31.524h1.999v20.081h-1.999z" transform="matrix(.94672236 -.3220509 .3220509 .94672236 -10.904 17.213)"/>
              ...
              <path d="m13.045 44.941h20.081v2.001h-20.081z" transform="matrix(.17230734 -.98504324 .98504324 .17230734 -26.146 60.766)"/>
              <path d="m21.691 49.882h11.922v1.999h-11.922z" transform="matrix(.16265439 -.98668311 .98668311 .16265439 -27.05 69.888)"/>
              <path d="m7.72 44.009h20.08v2.001h-20.08z" transform="matrix(.17225577 -.98505226 .98505226 .17225577 -29.636 54.751)"/>
            </svg>
          </h2>
