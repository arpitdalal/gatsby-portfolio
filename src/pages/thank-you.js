    ...
    <CustomLayout>
      ...
      <div className="d-flex flex-column justify-content-center align-items-center w-100 h-100">
        <div className="p-3">
          ...
          <h5 className="mt-3 anim">
            I will get back to you as soon as I can.
          </h5>
          <h5 className="mt-3 anim">
            Meanwhile if you want to reach me directly, you can email me at{" "}
            <a href="mailto:arpit@arpitdalal.dev">
              <u>arpit@arpitdalal.dev</u>
            </a>
          </h5>
          <h2 className="d-flex justify-content-center anim">
            ...
            >
              <path
                d="m25.063 27.666-9.435-1.847-.266 1.522-3.8-.665a4.63 4.63 0 0 0 -5.362 3.766l-2.534 14.458a4.635 4.635 0 0 0 3.767 5.36l3.8.666-.4 2.282a1.545 1.545 0 1 0 -.533 3.043l21.3 3.726a1.545 1.545 0 0 0 .532-3.044l.868-4.911s-7.813-22.769-7.864-23.074zm-13.294 20.216-3.043-.532a2.316 2.316 0 0 1 -1.883-2.681l2.262-12.934a2.316 2.316 0 0 1 2.681-1.883l3.043.532z"
                fill="#cfcfcf"
              />
              <path
                className="fill-color"
                d="m25 28.965.134-.044-.071-1.255-9.244-1.809-4.819 27.143a1 1 0 0 0 .831 1.144l20.026 3.676a1 1 0 0 0 1.143-.82l-.552-5.648z"
                fill="#7f5af0"
              />
              <path
                d="m25.463 29.377 8.956 26.323a1.544 1.544 0 1 0 1 2.924l20.473-6.965a1.544 1.544 0 1 0 -.995-2.924l-.897-2.635 3.078-1.047a4.634 4.634 0 0 0 2.894-5.879l-4.731-13.894a4.633 4.633 0 0 0 -5.88-2.895l-3.077 1.047-.347-1.02zm29.883 13-2.346.8-5.721-16.82 2.346-.8a2.318 2.318 0 0 1 2.94 1.447l4.229 12.43a2.317 2.317 0 0 1 -1.448 2.942z"
                fill="#cfcfcf"
              />
              <path
                className="fill-color"
                d="m46 22-21 6.965 8.661 26.035a1.077 1.077 0 0 0 1.339.62l19.332-6.354a.988.988 0 0 0 .668-1.266z"
                fill="#7f5af0"
              />
              <g fill="#f9f2cc">
              ...
              <path
                d="m40.455 33.265h1.999v20.081h-1.999z"
                transform="matrix(.94671111 -.32208395 .32208395 .94671111 -11.739 15.66)"
              />
              <path
                d="m35.337 35.006h1.999v20.081h-1.999z"
                transform="matrix(.94671111 -.32208395 .32208395 .94671111 -12.573 14.104)"
              />
              <path
                d="m45.574 31.524h1.999v20.081h-1.999z"
                transform="matrix(.94672236 -.3220509 .3220509 .94672236 -10.904 17.213)"
              />
              ...
              <path
                d="m13.045 44.941h20.081v2.001h-20.081z"
                transform="matrix(.17230734 -.98504324 .98504324 .17230734 -26.146 60.766)"
              />
              <path
                d="m21.691 49.882h11.922v1.999h-11.922z"
                transform="matrix(.16265439 -.98668311 .98668311 .16265439 -27.05 69.888)"
              />
              <path
                d="m7.72 44.009h20.08v2.001h-20.08z"
                transform="matrix(.17225577 -.98505226 .98505226 .17225577 -29.636 54.751)"
              />
            </svg>
          </h2>
          <div className="d-flex flex-column flex-md-row">
            ...
            <Link to="/me" className="cta cta-secondary anim">
              Know more about me
            </Link>
          </div>
        </div>
