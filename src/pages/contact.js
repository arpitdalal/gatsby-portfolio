    ...
    <CustomLayout>
      ...
      <div className="card-body">
        <div id="contactDiv" className="main-div">
          ...
          <p className="px-5 anim">
            You have a business that needs web presence or starting one online
            and want to build a great web experience for your customers?
          </p>
          ...
          <h4 className="anim">
            Or reach me out at{" "}
            <a className="purple" href="mailto:arpit@arpitdalal.dev">
              arpit@arpitdalal.dev
            </a>
          </h4>

          <h4 className=" mt-4 anim">
            If you like what I do, support me by buying me a coffee.
          </h4>
          <div className="bmc-btn-container mx-auto anim">
            <a
              ...
              target="_blank"
              href="http://buymeacoffee.com/arpitdalal"
            >
              <svg
                width={40}
                height={40}
